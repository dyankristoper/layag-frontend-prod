    ...
    <>
      ...
      <div className="Tour">
        ...
        <div className="Tour__Title">
          <h3>
            5 Tours Found In <span>Cebu</span>
          </h3>
        </div>
        ...
        <div className="Tour__information">
          ...
          <div className="details-section">
            <div className="details-section__choices">
              <div className="image">
                <img
                  src="https://pbs.twimg.com/media/DV5hSLkXcAAEj12.jpg:large"
                  alt="kawasan"
                />
              </div>
              <div className="details">
                <h3>4 Days 3 Nights South of Cebu Tour</h3>
                ...
                <p>This elegant, 19th-century building overlooks Lake Maggiore. You will find every comfort for a relaxing break including a swimming pool, gym, and games room.</p>
